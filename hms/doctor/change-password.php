...
{
$sql=$con->prepare("SELECT password FROM  doctors where password='".md5($_POST['cpass'])."' && id='".$_SESSION['id']."'");
$sql->execute();
$result = $sql->fetchAll();

if($result)
{
 $sql=$con->prepare("update doctors set password='".md5($_POST['npass'])."', updationDate='$currentTime' where id='".$_SESSION['id']."'");
 $sql->execute();
...
<html lang="en">
	<head>
		<title>
		Docteur | changer le mot de passe</title>
		<meta charset="utf-8" />
					...
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">
									Docteur | changer le mot de passe</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Docteur</span>
